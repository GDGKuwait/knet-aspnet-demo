          ...
          */   
            ...
            */
	            ...
	            // Read by PG and redirects the user to this URL 	
                    ...
                    Response.Write("REDIRECT=https://www.knetpaytest.com.kw/ASP/Error.aspx?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
                }
            %>
